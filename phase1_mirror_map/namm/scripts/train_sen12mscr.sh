...
# ── Resource allocation ────────────────────────────────────────────────────
#SBATCH --job-name=namm_sen12mscr
...
#SBATCH --mem=64G                  # TODO: increase if OOM
...
# ── USER SETTINGS ──────────────────────────────────────────────────────────
CODE_DIR="${HOME}/cs159/phase1_mirror_map/namm"   # TODO: absolute path to namm/
DATA_ROOT="/data"                                  # TODO: SEN12MS-CR root on HPC
OUTPUT_DIR="/scratch/${USER}/cs159/checkpoints/namm_sen12mscr"
CONDA_ENV="emrdm"                                  # TODO: conda env name
# ── END USER SETTINGS ──────────────────────────────────────────────────────
