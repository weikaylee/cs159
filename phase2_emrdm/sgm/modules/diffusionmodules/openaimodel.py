...
class ResidualUNetModel(UNetModel):
    def __init__(
        self, 
        *args,
        **kwargs
    ...
    def forward(
        ...
        **kwargs,
        ...
        hs = []
        t_emb1 = timestep_embedding(timesteps[0], self.model_channels, repeat_only=False)
        emb1 = self.time_embed(t_emb1)

        t_emb2 = timestep_embedding(timesteps[1], self.model_channels, repeat_only=False)
