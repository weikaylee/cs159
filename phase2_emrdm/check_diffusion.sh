...
EDM_CKPT="/resnick/groups/perona/oywang/cs159/runs/mirror_edm_final2/last.pt"
OUTPUT_DIR="/resnick/groups/perona/oywang/cs159/output/mirror_diffusion_check_ep10"
...
python "$CODE_DIR/run_mirror_diffusion.py" \
    ...
    --n_channels 13 --ngf 64 --n_res_blocks 6 \
    --base_ch 64 --depth 4 --emb_dim 256 \
    --sigma_data 0.033 --sigma_max 5.0 --steps 40 \
    --max_samples 12 --split test --batch_size 4
