#!/bin/bash
#SBATCH -J "verify SEN12MS-CR dataset"   # job name
...
/resnick/groups/perona/oywang/conda_envs/myenv/bin/python phase1_mirror_map/namm/scripts/verify_dataset.py --data_root data
